            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <Popover.Group as="nav" className="hidden md:flex space-x-10">
                        ...
                        {/* <a href="https://" className="text-base font-medium text-gray-500 hover:text-gray-900">
                            Pricing
                        </a>
                        <a href="https://" className="text-base font-medium text-gray-500 hover:text-gray-900">
                            Docs
                                            ...
                                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                                                ...
                                                <div className="px-5 py-5 bg-gray-50 sm:px-8 sm:py-8">
                                                    ...
                                                    <div className="mt-5 text-sm">
                                                        <a href="https://" className="font-medium text-indigo-600 hover:text-indigo-500">
                                                            {' '}
                    ...
                    <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                        {/* 
                        <a href="https://" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
                            Sign in
                        </a>
                        <a
                            href="https://"
                    ...
                    <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                        ...
                        <div className="py-6 px-5 space-y-6">
                            <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                                {/* <a href="https://" className="text-base font-medium text-gray-900 hover:text-gray-700">
                                    Pricing
                                </a>
                            ...
                            <div>
                                ...
                                <p className="mt-6 text-center text-base font-medium text-gray-500">
                                    Existing customer?{' '}
                                    <a href="https://" className="text-indigo-600 hover:text-indigo-500">
                                        Sign in
                                    </a>
                                </p>
 */}
