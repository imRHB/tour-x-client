...
const Header = () => {
    return (
		...
		transition duration-500 ease-in-out">
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                ...
                                <span className="ml-4 capitalize">expenses</span>
                            </span>
                        </button>
                    </li>
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                ...
                                <span className="ml-4 capitalize">wallet</span>
                            </span>
                        </button>
                    </li>
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                <img src="" alt="" />
                                <span className="ml-4 capitalize">manage team</span>
                            </span>
                        </button>
                    </li>
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                ...
                                <span className="ml-4 capitalize">manage cards</span>
                            </span>
                        </button>
                    </li>
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                <img src="" alt="" />
                                <span className="ml-4 capitalize">company profile</span>
                            </span>
                        </button>
                    </li>
				...
				duration-500 ease-in-out">
					...
					focus:outline-none w-full transition duration-500 ease-in-out">
                            ...
                            <span className="flex items-center">
                                ...
                                <span className="ml-4 capitalize">manage categories</span>
                            </span>
                        </button>
                    </li>
		...
		duration-500 ease-in-out">
			...
			duration-500 ease-in-out">
                    <h2 className="text-4xl font-medium capitalize">expenses</h2>
